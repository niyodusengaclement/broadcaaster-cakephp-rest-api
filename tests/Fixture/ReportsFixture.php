...
class ReportsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'image_url' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'created' => '2020-12-01 11:54:20',
                'modified' => '2020-12-01 11:54:20',
            ],
        ];
        parent::init();
    }
